...
@section('content')
    ...
    <container class="card card-form">
        ...
        <h1 class="card-header text-center title">Ajouter un nouveau référendum</h1>

        <div class="card-body">
            <form action="{{ route('votes.store') }}" method="post" class="form">
                @csrf
                <div class="form-floating mb-3">
                    <input placeholder="Titre" class="form-control @error('title') is-invalid @enderror" id="title" value="{{ old('title') }}" type="text" name="title">
                ...
                <div class="form-floating mb-3">
                    <textarea placeholder="Description" class="form-control @error('description') is-invalid @enderror" id="description" name="description">{{ old('description') }}</textarea>
                ...
                <div class="form-floating mb-3">
                    <input placeholder="Date et heure de fin" class="form-control @error('final_date') is-invalid @enderror" id="final_date" value="{{ old('final_date') }}" type="datetime-local" name="final_date">
